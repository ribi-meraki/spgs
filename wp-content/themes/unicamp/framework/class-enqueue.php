...
if ( ! class_exists( 'Unicamp_Enqueue' ) ) {
	class Unicamp_Enqueue {
		...
		public function register_swiper() {
			...
			wp_register_style( 'swiper', UNICAMP_THEME_URI . '/assets/libs/swiper/css/swiper.min.css', array(), '8.4.5' );
		...
		public function polyfill_script() {
			wp_enqueue_script( 'intersection-observer', UNICAMP_THEME_URI . '/assets/libs/polyfill/intersection-observer.min.js', array(), null, true );
		}
		...
		public function frontend_scripts() {
			 ...
			 */
			wp_register_style( 'unicamp-woocommerce', UNICAMP_THEME_URI . "/woocommerce{$min}.css", array(), UNICAMP_THEME_VERSION );

			wp_register_style( 'font-awesome-pro', UNICAMP_THEME_URI . '/assets/fonts/awesome/css/fontawesome-all.min.css', array(), '6.4.2' );
			...
			wp_register_style( 'justifiedGallery', UNICAMP_THEME_URI . '/assets/libs/justifiedGallery/css/justifiedGallery.min.css', array(), '3.7.0' );
			...
			wp_register_style( 'lightgallery', UNICAMP_THEME_URI . '/assets/libs/lightGallery/css/lightgallery.min.css', array(), '1.6.12' );
			...
			wp_register_style( 'magnific-popup', UNICAMP_THEME_URI . '/assets/libs/magnific-popup/magnific-popup.css', array(), '1.1.0' );
			wp_register_script( 'magnific-popup', UNICAMP_THEME_URI . '/assets/libs/magnific-popup/jquery.magnific-popup.js', array( 'jquery' ), '1.1.0', true );

			wp_register_style( 'growl', UNICAMP_THEME_URI . '/assets/libs/growl/css/jquery.growl.min.css', array(), '1.3.3' );
			wp_register_script( 'growl', UNICAMP_THEME_URI . '/assets/libs/growl/js/jquery.growl.min.js', array( 'jquery' ), '1.3.3', true );

			wp_register_script( 'matchheight', UNICAMP_THEME_URI . '/assets/libs/matchHeight/jquery.matchHeight-min.js', array( 'jquery' ), '0.7.2', true );
			...
			wp_register_script( 'picturefill', UNICAMP_THEME_URI . '/assets/libs/picturefill/picturefill.min.js', array( 'jquery' ), '2.3.1', true );

			wp_register_script( 'mousewheel', UNICAMP_THEME_URI . '/assets/libs/mousewheel/jquery.mousewheel.min.js', array( 'jquery' ), '3.1.13', true );

			$google_api_key = $this->get_google_api_key();
			wp_register_script( 'unicamp-gmap3', UNICAMP_THEME_URI . '/assets/libs/gmap3/gmap3.min.js', array( 'jquery' ), '7.2', true );
			wp_register_script( 'unicamp-maps', UNICAMP_PROTOCOL . '://maps.google.com/maps/api/js?key=' . $google_api_key . '&amp;language=en' );

			wp_register_script( 'isotope-masonry', UNICAMP_THEME_URI . '/assets/libs/isotope/js/isotope.pkgd.js', array( 'jquery' ), '3.0.6', true );
			wp_register_script( 'isotope-packery', UNICAMP_THEME_URI . '/assets/libs/packery-mode/packery-mode.pkgd.js', array( 'jquery' ), '2.0.1', true );
			 ...
			 */
			wp_enqueue_style( 'unicamp-style', get_template_directory_uri() . "/style{$min}.css", array(), UNICAMP_THEME_VERSION );
			...
			if ( ! wp_script_is( 'elementor-waypoints', 'registered' ) ) {
				wp_register_script( 'elementor-waypoints', UNICAMP_THEME_URI . '/assets/libs/elementor-waypoints/jquery.waypoints.min.js', array( 'jquery' ), '4.0.1', true );
			}
			...
			wp_enqueue_script( 'jquery-smooth-scroll', UNICAMP_THEME_URI . '/assets/libs/smooth-scroll/jquery.smooth-scroll.min.js', array( 'jquery' ), '2.2.0', true );

			wp_enqueue_script( 'unicamp-swiper-wrapper' );

			wp_enqueue_script( 'smartmenus' );

			wp_enqueue_style( 'perfect-scrollbar', UNICAMP_THEME_URI . '/assets/libs/perfect-scrollbar/css/perfect-scrollbar.min.css', array(), '0.6.14' );
			wp_enqueue_script( 'perfect-scrollbar', UNICAMP_THEME_URI . '/assets/libs/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js', array( 'jquery' ), '0.6.14', true );
			...
			$js_variables = array(
				...
				'nonce'                     => wp_create_nonce( 'unicamp-security' ),
		...
		public function rtl_styles() {
			...
			wp_register_style( 'unicamp-style-rtl', UNICAMP_THEME_URI . "/style-rtl$min.css", array(), UNICAMP_THEME_VERSION );
