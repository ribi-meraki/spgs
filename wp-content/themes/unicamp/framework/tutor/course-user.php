...
if ( ! class_exists( 'Unicamp_Course_User' ) ) {
	class Unicamp_Course_User {
		...
		public function initialize() {
			...
			add_filter( 'unicamp_login_url', [ $this, 'update_login_url' ], 20 );
			add_filter( 'unicamp_register_url', [ $this, 'update_register_url' ], 20 );
		...
		public function update_register_url( $url ) {
			$url_arg = array(
				'redirect_to' => rawurlencode(tutor()->current_url),
			);
			if ( is_single_course() ) {
